...
GlobalConfig::$CONNECTION_SETTING->DBName = "db_eca";
GlobalConfig::$CONNECTION_SETTING->Username = "root";
GlobalConfig::$CONNECTION_SETTING->Password = "root";
...
/** the root url of the application with trailing slash, for example http://localhost/eca/ */
GlobalConfig::$ROOT_URL = RequestUtil::GetServerRootUrl() . 'eca/';
