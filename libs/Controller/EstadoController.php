...
class EstadoController extends AppBaseController
{
	...
	public function Create()
	{
		try
		{
			...
			// $estado->IdState = $this->SafeGetVal($json, 'idState');

			$estado->StrUf = $this->SafeGetVal($json, 'strUf');
			$estado->StrName = $this->SafeGetVal($json, 'strName');
			$estado->TbRegionIdRegion = $this->SafeGetVal($json, 'tbRegionIdRegion');
	...
	public function Update()
	{
		try
		{
			...
			// $estado->IdState = $this->SafeGetVal($json, 'idState', $estado->IdState);

			$estado->StrUf = $this->SafeGetVal($json, 'strUf', $estado->StrUf);
			$estado->StrName = $this->SafeGetVal($json, 'strName', $estado->StrName);
			$estado->TbRegionIdRegion = $this->SafeGetVal($json, 'tbRegionIdRegion', $estado->TbRegionIdRegion);
