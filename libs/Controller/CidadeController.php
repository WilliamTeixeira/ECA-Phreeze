...
class CidadeController extends AppBaseController
{
	...
	public function Create()
	{
		try
		{
			...
			// $cidade->IdCity = $this->SafeGetVal($json, 'idCity');

			$cidade->StrNameCity = $this->SafeGetVal($json, 'strNameCity');
			$cidade->StrCodSiafiCity = $this->SafeGetVal($json, 'strCodSiafiCity');
			$cidade->TbStateIdState = $this->SafeGetVal($json, 'tbStateIdState');
	...
	public function Update()
	{
		try
		{
			...
			// $cidade->IdCity = $this->SafeGetVal($json, 'idCity', $cidade->IdCity);

			$cidade->StrNameCity = $this->SafeGetVal($json, 'strNameCity', $cidade->StrNameCity);
			$cidade->StrCodSiafiCity = $this->SafeGetVal($json, 'strCodSiafiCity', $cidade->StrCodSiafiCity);
			$cidade->TbStateIdState = $this->SafeGetVal($json, 'tbStateIdState', $cidade->TbStateIdState);
