...
class UsuarioController extends AppBaseController
{
	...
	public function Query()
	{
		try
		{
			...
			if ($filter) $criteria->AddFilter(
				new CriteriaFilter('Iduser,Usuario,Senha,Nome,Email,Resetar,Perfil'
				, '%'.$filter.'%')
			);
	...
	public function Create()
	{
		try
		{
			...
			$usuario->Usuario = $this->SafeGetVal($json, 'usuario');
			$usuario->Senha = $this->SafeGetVal($json, 'senha');
			$usuario->Nome = $this->SafeGetVal($json, 'nome');
			$usuario->Email = $this->SafeGetVal($json, 'email');
			$usuario->Resetar = $this->SafeGetVal($json, 'resetar');
			$usuario->Perfil = $this->SafeGetVal($json, 'perfil');
	...
	public function Update()
	{
		try
		{
			...
			$usuario->Usuario = $this->SafeGetVal($json, 'usuario', $usuario->Usuario);
			...
			$usuario->Resetar = $this->SafeGetVal($json, 'resetar', $usuario->Resetar);
			$usuario->Perfil = $this->SafeGetVal($json, 'perfil', $usuario->Perfil);
