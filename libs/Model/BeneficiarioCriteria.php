...
require_once("DAO/BeneficiarioCriteriaDAO.php");

/**
 * The BeneficiarioCriteria class extends BeneficiarioDAOCriteria and is used
 ...
 * @version 1.0
 */
class BeneficiarioCriteria extends BeneficiarioCriteriaDAO
{
