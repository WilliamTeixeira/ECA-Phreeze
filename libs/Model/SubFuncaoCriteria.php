...
require_once("DAO/SubFuncaoCriteriaDAO.php");

/**
 * The SubFuncaoCriteria class extends SubFuncaoDAOCriteria and is used
 ...
 * @version 1.0
 */
class SubFuncaoCriteria extends SubFuncaoCriteriaDAO
{
