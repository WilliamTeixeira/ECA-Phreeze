...
require_once("DAO/ProgramaCriteriaDAO.php");

/**
 * The ProgramaCriteria class extends ProgramaDAOCriteria and is used
 ...
 * @version 1.0
 */
class ProgramaCriteria extends ProgramaCriteriaDAO
{
