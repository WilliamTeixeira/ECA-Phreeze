...
require_once("DAO/ArquivoCriteriaDAO.php");

/**
 * The ArquivoCriteria class extends ArquivoDAOCriteria and is used
 ...
 * @version 1.0
 */
class ArquivoCriteria extends ArquivoCriteriaDAO
{
